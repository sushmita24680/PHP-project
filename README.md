# PHP-project
php based website (MUSIC WEBSITE)
...
We used HTML, PHP/MySQLi, CSS, JavaScript (jQuery/Ajax), and Bootstrap for the design. The source code is fully functional and easy to modify or enhance. Follow the instruction below to have an actual experience using this simple project.
...
Open a web browser and browse the project. E.g [http://localhost/PHP-PROJECT]

Done by Arhan Ali Khan and Sushmita Kumari.