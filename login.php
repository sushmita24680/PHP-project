  	...
  	<div class="container">
  		...
  		<div id="login-center" class="row justify-content-center align-self-center w-100">
  			<div class="d-flex justify-content-center align-items-center w-100">
  				<span  class=" m-5 p-2">
  				<h1 class="text-gradient-primary text-center" style="font-size: 4rem"><b><img src="logo2.png" style="width:14rem;" /></b></h1>
  				
  				</span>
  			</div>
  			<div class="card  bg-transparent  text-white col-md-7 p-3">
  				<div class="card-body">
  					<form id="login-form" >
  						...
  						<center><button class="btn btn-block btn-wave btn-success bg-gradient-success " type="button" id="new_account">Create New Account</button></center>
  					</form>
  				</div>
  			</div>
  		</div>
